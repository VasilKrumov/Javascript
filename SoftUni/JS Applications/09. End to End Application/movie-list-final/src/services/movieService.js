...
export const create = (title, imageUrl, description) =>
    request.post(`${api.movies}`, { title, img: imageUrl, description })

export const update = (movieId, title, imageUrl, description) =>
    request.put(`${api.movies}/${movieId}`, { title, img: imageUrl, description })
